...
axs[2, 0].hist(adata.obs['knnMONO'],50)
axs[2, 0].set_title("knnMONO")
fig.tight_layout()
...
sns.kdeplot(data=adata.obs, x='knnCD8', y='knnCD4', levels=30, ax=axs[0])
sns.kdeplot(data=adata.obs, x='knnCD3', y='knnIAC', levels=30, ax=axs[1])
sns.kdeplot(data=adata.obs, x='knnCD3', y='knnMONO', levels=30, ax=axs[2])
#sns.kdeplot(data=adata[barcodes_random_sel].obs, x='knnCD8', y='knnCD4', levels=30, ax=axs[0,0])
#sns.kdeplot(data=adata[barcodes_random_sel].obs, x='knnCD3', y='knnIAC', levels=30, ax=axs[0,1])
#sns.kdeplot(data=adata[barcodes_random_sel].obs, x='knnCD3', y='knnMONO', levels=30, ax=axs[1,0])
